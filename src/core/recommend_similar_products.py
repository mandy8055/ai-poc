...
print(f"\nðŸ” DEBUG: Analyzing {len(products)} products...")
print("=" * 80)
...
print("ðŸ” SIMILARITY ANALYSIS - Top 5 similar products:")
print("-" * 80)
count = 0
for idx in top_results:
    ...
    # if common_words:
    #     print(f"      âœ… Common words: {', '.join(sorted(common_words))}")
    ...
    try:
        ...
        if query_price and candidate_price:
            ...
            if price_diff_pct < 20:
                print(f"      ðŸ’° Similar price range (Â±{price_diff_pct:.1f}%)")
    except:
        pass
